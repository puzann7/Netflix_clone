...
function MediaDisplayIcon({backdrop,poster, ref}) {
    const posterLink = `${import.meta.env.VITE_IMG_URL}w500/${poster}`;
    const backdropLink = `${import.meta.env.VITE_IMG_URL}w500/${backdrop}`;
  return (
    <div ref={ref && ref} className='shrink-0 snap-start  cursor-pointer w-[102px] h-[160px] md:w-[170px] md:h-[272px] lg:w-[218px] lg:h-[123px]  '>
        <picture>
...
export default MediaDisplayIcon
